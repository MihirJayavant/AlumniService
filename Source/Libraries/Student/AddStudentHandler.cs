...
public sealed class AddStudentCommandValidator : AbstractValidator<AddStudent>
{
    public AddStudentCommandValidator() => RuleFor(x => x.Email).EmailAddress();
}


public class AddStudentHandler : IRequestHandler<AddStudent, OneOf<StudentResponse, ErrorType>>
{
